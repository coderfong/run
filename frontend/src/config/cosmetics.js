...
export const ITEMS = {
  ...
  hair: [
    ...
    { id: 'swept', label: 'Swept', art: ART.hairM3, rarity: 'common', unlock: free },
    { id: 'curls', label: 'Curls', art: ART.hairM5, rarity: 'common', unlock: free },
    { id: 'pixie', label: 'Pixie', art: ART.hairW10, rarity: 'common', unlock: free },
    ...
    { id: 'topknot', label: 'Top knot', art: ART.hairM2, layout: { w: 0.95, top: -0.115 }, rarity: 'rare', unlock: dist(25, 'Run 25 km total') },
    { id: 'sidepony', label: 'Side pony', art: ART.hairW9, layout: { top: -0.03 }, rarity: 'rare', unlock: dist(25, 'Run 25 km total') },
    { id: 'fringebun', label: 'Fringe bun', art: ART.hairM7, layout: { w: 0.95, top: -0.12 }, rarity: 'rare', unlock: zones(3, 'Hold 3 zones') },
    { id: 'highpony', label: 'High pony', art: ART.hairW7, layout: { w: 0.98, top: -0.13 }, rarity: 'rare', unlock: streak(2, 'Hold a 2-week streak') },
    { id: 'lowbun', label: 'Low bun', art: ART.hairW13, layout: { top: -0.03 }, rarity: 'rare', unlock: zones(5, 'Hold 5 zones') },
    { id: 'surfer', label: 'Surfer', art: ART.hairM9, rarity: 'epic', unlock: dist(100, 'Run 100 km total') },
    { id: 'curlylong', label: 'Curly long', art: ART.hairW3, layout: { top: -0.015 }, rarity: 'epic', unlock: dist(100, 'Run 100 km total') },
    { id: 'spacebuns', label: 'Space buns', art: ART.hairW8, layout: { w: 1.0, top: -0.075 }, rarity: 'epic', unlock: zones(10, 'Hold 10 zones') },
  ],
  glasses: [
  ...
  top: [
    ...
    { id: 'hoodie', label: 'Hoodie', art: ART.top7, layout: { top: 0.297 }, rarity: 'common', unlock: runs(3, 'Finish 3 runs') },
    { id: 'daisydress', label: 'Daisy dress', art: ART.top4, rarity: 'common', unlock: runs(5, 'Finish 5 runs') },
    { id: 'overshirt', label: 'Overshirt', art: ART.top6, rarity: 'rare', unlock: runs(10, 'Finish 10 runs') },
  ...
  bottom: [
    ...
    { id: 'skirt', label: 'Skirt', art: ART.bottom2, layout: { w: 0.70 }, rarity: 'common', unlock: free },
