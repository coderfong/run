...
| `headerPasers` | `ui/header-pasers.png` | 640 × 500 | "Add pasers" header | A tight huddle of 5–6 runners in different colours, arms over shoulders, seen from slightly below. |
