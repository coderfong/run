...
class Run(Base):
    ...
    # NULL = phone (every run before rev 0050, and every ordinary run since).
    # 'watch' = a standalone Apple Watch workout submitted to /start-run after
    # it already finished, with a backdated started_at — see rev 0050 and the
    ...
    # calibration — see migration 0049 and schemas.RunSessionIn.
